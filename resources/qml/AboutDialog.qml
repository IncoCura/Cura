...
UM.Dialog
{
    ...
    Label
    {
        ...
        text: catalog.i18nc("@info:credit","3D Inventor is devloped based on Cura, and it is developed by Ultimaker B.V. in cooperation with the community.\nCura proudly uses the following open source projects:")
        font: UM.Theme.getFont("system")
        wrapMode: Text.WordWrap
    ...
    ScrollView
    {
        ...
        ListView
        {
            ...
            {
			    projectsModel.append({ name:"3D Inventor", description: catalog.i18nc("@label", "3D Inventor based on Ultimaker Cura"), license: "LGPLv3", url: "https://github.com/KangDroid/Cura" });
                projectsModel.append({ name:"Ultimaker Cura", description: catalog.i18nc("@label", "Graphical user interface"), license: "LGPLv3", url: "https://github.com/Ultimaker/Cura" });
